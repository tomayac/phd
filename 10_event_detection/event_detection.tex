...
In the previous chapters, we have focused on the creation of event summaries 
for well-known, planned events (\emph{e.g.}, the Super Bowl XLVII event)
or unplanned events (\emph{e.g.}, the 2013 Taksim Gezi Park protests).
...
%  indicating whether or not the current document is the   first story discussing a~novel event at that time''.}
%\end{quotation}
