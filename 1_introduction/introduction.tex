...
We evaluate the media item extractors with different events
...
We evaluated the approach with videos from a~popular video hosting platform in form of a~browser extension.
