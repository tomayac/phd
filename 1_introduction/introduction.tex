...
becoming a~source of breaking news to be taken seriously
that probably has gone mainstream for the first time
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\linewidth]{wahlschau}
...
Examples of such manual social media curation tools are FlypSite,%
\footnote{\url{http://www.flyp.tv/}},
a~tool that facilitates the creation of embeddable
second screen applications or TV social media widgets, Storify,%
