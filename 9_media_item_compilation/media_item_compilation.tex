...
(\url{http://social-media-illustrator.herokuapp.com/}),
this data is maintained in the form of HTML hyperlinks
back to the source social networks.
...
An example of a~media gallery generated in the context
of the 2013 Taksim Gezi Park protests%
\footnote{\url{http://en.wikipedia.org/wiki/2013_Taksim_Gezi_Park_protests}, accessed June 1, 2013}
...
Up to now, we have presented static media galleries
and different algorithms to generate media galleries of different styles.
