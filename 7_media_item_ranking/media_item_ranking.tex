...
textual content can be linked to \emph{LOD} cloud concepts~\cite{Facebook2011}.
...
Nevertheless the application proposes reasonable default values
for each individual parameter that have been demonstrated
to work well enough for the majority of cases.
