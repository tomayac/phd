...
In this subsection, we present the human rater results in the form of MOS scores
of the events we tested our empirically determined ranking formula with.

\begin{table}
\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|}
\hline
\backslashbox{\textbf{Event}}{\textbf{Rank}}&\textbf{1}&\textbf{2}&\textbf{3}&\textbf{4}&\textbf{5}&\textbf{6}&\textbf{7}&\textbf{8}&\textbf{9}&\textbf{10}\\ \hline
\textbf{Facebook Graph Search Launch}&~&~&~&~&~&~&~&~&~&~\\ \hline
\textbf{BlackBerry 10 Launch}&~&~&~&~&~&~&~&~&~&~\\ \hline
\textbf{Qualcomm CES 2013 Keynote}&~&~&~&~&~&~&~&~&~&~\\ \hline
\textbf{Super Bowl XLVII}&~&~&~&~&~&~&~&~&~&~\\
\hline
\caption[Mean Opinion Scores (MOS) for top-10 ranked media items]
  {Mean Opinion Scores (MOS) for the top-10 ranked media items of four events}
\end{tabular}
\end{table}
