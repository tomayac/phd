...
Microformats,\footnote{\url{http://microformats.org/wiki/Main_Page\#Specifications}, accessed July 16, 2013}
as listed below:
...
inspired by a~default example of the Apache Any23 project
(Anything To Triples, \url{http://any23.org/}).
...
\begin{lstlisting}[caption={[Fictive SPARQL query returning names and
  ...
  person in the world
  (\url{http://en.wikipedia.org/wiki/SPARQL\#Benefits})}},
  label={code:sparql}]
PREFIX foaf: <http://xmlns.com/foaf/0.1/>
SELECT ?name ?email
WHERE {
...
endpoint\footnote{\url{http://dbpedia.org/sparql}, accessed July 16, 2013}
...
\begin{figure}[!ht]
\centering
  \includegraphics[width=0.95\textwidth,height=0.9\textheight,keepaspectratio]{lod-cloud.png}    
  \caption[Linking Open Data cloud diagram as of September 2011]
  {Linking Open Data cloud diagram as of September 2011, by Richard Cyganiak and Anja Jentzsch \url{http://lod-cloud.net/} \todo{Check final orientation}}    
  \label{fig:lod-cloud}
\end{figure}
