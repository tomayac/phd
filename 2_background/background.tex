...
Most people prefer the Turtle~\cite{prudhommeaux2013turtle}
...
\begin{lstlisting}[caption={[A~sample graph in Turtle syntax]{A~sample graph in Turtle syntax,
...
\begin{lstlisting}[caption={[SPARQL query returning names and
  email addresses]
...
\cite{boyd2007socialnetworksites}
\cite{cyganiak2011lodcloud}
