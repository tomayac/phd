...
\autoref{fig:scenecrop} shows two different views on a~stage
...
Due to the high tile-wise similarity of the detailed scene,
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.4\linewidth]{./zoom.png}
