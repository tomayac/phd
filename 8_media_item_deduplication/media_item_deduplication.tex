...
(\autoref{sec:near-duplicate-content}),
...
\begin{figure}[t!]
  ...
  \caption[Our approach compared to state-of-the art algorithms]{Our approach compared to the state-of-the art feature detection algorithms SIFT, Affine-SIFT, and SURF}
  \label{fig:snowden}
\end{figure}
