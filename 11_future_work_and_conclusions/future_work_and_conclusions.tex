...
In many of our evaluated tasks from the previous chapters
we had to deal with subjective data.
...
\emph{subjectivity} is a~term used to refer to the condition
...
As a~second example, there are media gallery aesthetics and usefulness
...
\cite{brabb1964evaluation}

\cite{likert1932likertscale} \cite{itu1998mos}