...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|l|l|l|l|l|}
    \hline
        \backslashbox{\textbf{Property}}{\textbf{Application}}\textbf{Seen} & \textbf{Eventifier} & \textbf{Storify} & \textbf{Media Finder} & \textbf{Social Media Illustrator}\\ \hline
      \hline
      \textbf{Primary data source} & Twitter & Twitter & Multiple & Multiple & Multiple\\
      \textbf{Main task} & Event archiving & Event archiving & Event summarization & Event summarization & Event summarization\\
      \textbf{Operation mode} Automatic & Automatic & Manual & Semi-automatic & Semi-automatic\\
      \textbf{Permanent availability} & Yes & Yes & Yes & Yes & No\\
      \textbf{Downloadable} & No & No & No & No & Yes\\
      \textbf{Commercial} & Yes & Yes & Yes & No & No\\
      \hline
    \end{tabular}
    \caption{Comparison of commercial and non-commercial event archiving and summarization tools}
