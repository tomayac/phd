...
\newpage
\vspace{10mm}
1. Advisor: Joaquim Gabarró Vallés (UPC)

\vspace{10mm}
2. Advisor: Michael Hausenblas (DERI)
...
\include{6_media_item_deduplication/media_item_deduplication}
\include{7_media_item_ranking/media_item_ranking}
\include{8_media_item_compilation/media_item_compilation}
\include{9_future_work/future_work}
\include{10_conclusion/conclusion}
