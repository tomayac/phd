...
\addbibresource{backmatter/references}
...
\include{10_event_detection/event_detection}
\include{5_media_item_extraction/media_item_extraction}
\include{6_shot_boundary_detection/shot_boundary_detection}
\include{7_media_item_deduplication/media_item_deduplication}
\include{8_media_item_ranking/media_item_ranking}
\include{9_media_item_compilation/media_item_compilation}
