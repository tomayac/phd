...
\vspace{20mm}
\textbf{Day of the defense:} \todo{Add date}
...
\include{3_social_networks/social_networks}
\include{4_micropost_annotation/micropost_annotation}
\include{5_event_detection/event_detection}
\include{6_media_item_extraction/media_item_extraction}
\include{7_shot_boundary_detection/shot_boundary_detection}
\include{8_media_item_deduplication/media_item_deduplication}
\include{9_media_item_ranking/media_item_ranking}
\include{10_media_item_compilation/media_item_compilation}
\include{11_future_work_and_conclusions/future_work_and_conclusions}
